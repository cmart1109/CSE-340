...
-- Table Strucutre for table 'account'
...
('John', 'Karmack', 'jockar@340.edu', 'J@nKarmack340', 'Employee'),
('Shigeru', 'Miyamoto', 'miyamoto@340.edu', 'M!yaM0t0340', 'Admin');


INSERT INTO public.reviews (inv_id, account_id, rating, comment)
VALUES
(5, 1, 5, 'Amazing car! Smooth ride and excellent performance.'),
(5, 2, 4, 'Really good car, but a bit expensive.'),
(5, 3, 3, 'Average experience. Nothing special.'),
(5, 4, 5, 'Loved it! Great value for the price.'),
(5, 5, 4, 'Comfortable and stylish, would recommend.');
